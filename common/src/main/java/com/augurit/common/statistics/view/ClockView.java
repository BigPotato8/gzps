 ...
 * Created by sdb on 2019/9/25  11:06.
 * Desc：
 */
public class ClockView extends View {
    ...
    private static final int DEAFAULT_TITLE_SIZE = 14;
    private static final int DEFAULT_VALUE_SIZE = 26;
    ...
    private void drawTitleDial(Canvas canvas) {
        ...
        canvas.drawText(titleDial, 0, radiusDial * 2 / 3 - 80, titlePaint);
