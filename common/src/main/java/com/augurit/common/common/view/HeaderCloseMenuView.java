...
/**
 * 头部菜单View，收缩显示时
 * 横列的recyclerview，配合MenuItem
 */
public class HeaderCloseMenuView extends RelativeLayout {

    protected RecyclerView rv_menu;
    protected List<MenuItem> mMenuItems;
    protected MenuItemAdapter mAdapter;

    public HeaderCloseMenuView(Context context) {
        super(context);
        initView();
    }

    public HeaderCloseMenuView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public HeaderCloseMenuView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void initView() {
        ...
        mAdapter = new MenuItemAdapter(getContext(), mMenuItems, R.layout.common_view_header_menu_item_close);
