 ...
 * @modifyMemo 修改备注：
 */
public class AutoMenuItemAdapter extends RecyclerView.Adapter<AutoMenuItemAdapter.MenuHolder> {
    ...
    public AutoMenuItemAdapter(Context context, List<MenuItem> items, int itemLayout) {
        mContext = context;
    ...
    public void onBindViewHolder(MenuHolder holder, int position) {
        ...
        if (mBadgeMap.containsKey(position)) {
            ...
            if (o instanceof String) {
                badge.setBadgeText((String) o);
            } else if (o instanceof Integer) {
                badge.setBadgeNumber((Integer) o);
            }
            holder.itemView.setTag(badge);
        } else {
