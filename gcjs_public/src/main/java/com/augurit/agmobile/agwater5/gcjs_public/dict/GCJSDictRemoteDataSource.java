package com.augurit.agmobile.agwater5.gcjs_public.dict;
 ...
 * @MODIFYMEMO 修改备注:
 */
public class GCJSDictRemoteDataSource {

    public static Observable<List<Dict>> getAllDict() {
        return EasyHttp.get(GcjsPuUrlConstant.GET_DICT)
                .baseUrl(com.augurit.agmobile.agwater5.gcjs_public.common.AwUrlManager.serverUrl())
