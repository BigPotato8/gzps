...
public class MultiUploadEventThirdAdapter extends BaseViewListAdapter<MultiMaterialBean> {


    public MultiUploadEventThirdAdapter(Context context) {
        super(context);
    }
    ...
    public BaseDataViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MultiUploadEventThirdAdapter.LocalDraftViewHolder(View.inflate(mContext, R.layout.gcjs_public_upload_third_material_list_item, null));
    }

    @Override
    public void onBindViewHolder(BaseDataViewHolder holder, int position) {
        super.onBindViewHolder(holder, position);
        MultiUploadEventThirdAdapter.LocalDraftViewHolder mHolder = (MultiUploadEventThirdAdapter.LocalDraftViewHolder) holder;
