...
public class MaterialSupplyAdapter extends BaseViewListAdapter<String> {


    public MaterialSupplyAdapter(Context context) {
        super(context);
    }
    ...
    public BaseDataViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MaterialSupplyAdapter.LocalDraftViewHolder(View.inflate(mContext, R.layout.material_supply_item_view, null));
    }
