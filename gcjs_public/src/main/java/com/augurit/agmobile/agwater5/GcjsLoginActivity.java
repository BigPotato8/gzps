...
import com.augurit.agmobile.agwater5.gcjs_public.dict.GCJSDictRemoteDataSource;
 ...
 * @modifyMemo 修改备注：
 */
public class GcjsLoginActivity extends BaseLoginActivity {
    ...
    public static Intent getIntent(Context context, Class nextActivity) {
        Intent intent = new Intent(context, GcjsLoginActivity.class);
...
//                }, Throwable::printStackTrace);
        ...
        if (mNextActivity != null) {
            ...
            intent = new Intent(this, GcjsMainActivity.class);
        }
    ...
    protected LoginViewSettings initSettings() {
        ...
        if (intent != null
            ...
            mNextActivity = GcjsMainActivity.class;
        }
