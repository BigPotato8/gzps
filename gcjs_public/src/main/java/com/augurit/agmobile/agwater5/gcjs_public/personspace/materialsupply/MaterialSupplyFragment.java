...
public class MaterialSupplyFragment extends BaseViewListFragment {


    private String keyword = "";

    public static MaterialSupplyFragment newInstance() {
        MaterialSupplyFragment fragment = new MaterialSupplyFragment();
        return fragment;
    }
    ...
    protected BaseViewListAdapter initAdapter() {
        return new MaterialSupplyAdapter(getActivity());
    }
...
//        params.put("userId", keyword);
        ...
        return HttpUtil.getInstance(AwUrlManager.serverUrl()).get(GcjsPuUrlConstant.MATERIAL_SUPPLY_LIST, params).map(
                s -> {  //TODO s:  {"success":false,"message":"查材料补正列表查询接口异常"}
