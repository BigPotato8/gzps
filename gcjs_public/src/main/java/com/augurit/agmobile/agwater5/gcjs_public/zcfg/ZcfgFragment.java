...
public class ZcfgFragment extends BaseViewListFragment<ZcfgBean> {
    public static final String [] fgArray = {"hebeiRegulation","guojiaRegulation","tangshanRegulation"};
    public static final String [] fgTittleArray = {"国家政策法规","河北政策法规","唐山政策法规"};
                    ...
                    if (StringUtils.isJson(s)) {
                        ...
                        if (success) {
                            ...
                            for (String key : stringMap.keySet()) {
                                ZcfgBean zcfgBean = new ZcfgBean(stringMap.get(key), AwUrlManager.serverUrl() + "/aplanmis-rest" + key);
