...
public class SearchAdapter extends BaseViewListAdapter<String> {
    ...
    public BaseDataViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new SearchAdapter.LocalDraftViewHolder(View.inflate(mContext, R.layout.search_item_view, null));
    }
