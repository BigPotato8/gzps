...
public class ProjectRateAdapter extends BaseViewListAdapter<String> {


    public ProjectRateAdapter(Context context) {
        super(context);
    }
    ...
    public BaseDataViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ProjectRateAdapter.LocalDraftViewHolder(View.inflate(mContext, R.layout.project_rate_item_view, null));
    }
