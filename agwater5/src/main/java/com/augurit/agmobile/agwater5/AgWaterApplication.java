 ...
 * @modifyMemo 修改备注：
 */
public class AgWaterApplication extends Application implements RongIM.UserInfoProvider, RongIM.GroupInfoProvider, RongIM.GroupUserInfoProvider {
...
//                //每个library都要有realm的module，若想组件化时动态插拔drainage等模块，只能反射获取
//                String gzpsRealm = "com.augurit.agmobile.agwater5.GzpsAwRealmModule";
//                Object gzpsRealmModule = null;
//                try {
//                    gzpsRealmModule = Class.forName(gzpsRealm).newInstance();
//                } catch (Exception e) {
//                    e.printStackTrace();
//                }
...
//                                new AwRealmModule(),
                                ...
                                new BusinessArcGISRealmModule(),
                                new BusinessCommonRealmModule(),
                                new GzpsAwRealmModule(),
                                new CommonArcigsRealmModule()
//                                new SewageAwRealmModule(),
//                                new NNAwRealmModule(),
//                                new FloodAwRealmModule()
////                                new PshAwRealmModule()
                        )
                        .deleteRealmIfMigrationNeeded()
                        .build();
                // 初始化Realm单例
