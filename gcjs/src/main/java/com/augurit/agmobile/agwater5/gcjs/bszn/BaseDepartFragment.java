...
public class BaseDepartFragment extends BaseViewListFragment<String> {


    @Override
    protected BaseViewListAdapter<String> initAdapter() {
        return new BsznListAdapter(getActivity());
    }
    ...
    public void onItemClick(View view, int i, String o) {
        getActivity().startActivity(new Intent(getActivity(), BsznDetailActivity.class));
    }
