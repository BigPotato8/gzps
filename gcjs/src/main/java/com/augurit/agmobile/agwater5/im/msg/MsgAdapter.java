...
public class MsgAdapter extends BaseAdapter {
    ...
    public MsgAdapter(Context context, List<ActionBean> datas) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ActionBean data = mDatas.get(position);
        //String time = TimeUtil.getTimeStr(data.getCreateTime() / 1000);
        //holder.tv_time.setText(time);
        holder.tv_title.setText(data.getActionName());
        holder.img_item.setImageResource(data.getActionUri());
...
//        }
    ...
    public interface OnItemClickListener {
        void onItemClick(int position, ActionBean data);
    }
