...
//消息详情
public class MessageDetailFragment extends BasePadFragment {

    Message.RowsBean rowsBean;

    public static MessageDetailFragment getInstance(Message.RowsBean rowsBean){
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_message_detail_pad,container,false);
        return view;
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if (rowsBean != null) {
            ...
            tv_author.setText(rowsBean.getSendUserName());
            tv_date.setText(TimeUtil.getStringTimeYMDFromDate(new Date(rowsBean.getCreateTime())));
