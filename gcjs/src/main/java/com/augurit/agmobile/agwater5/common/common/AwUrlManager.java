...
//        BASE_URL_PSXJ = serverUrl.concat(":8086/");
//        BASE_URL_PSXJ = serverUrl.concat(":7050/");
//        BASE_URL_PSXJ = serverUrl.concat(":7071/");
//        BASE_URL_PSXJ = serverUrl.concat(":18081/"); //测试环境
        BASE_URL_PSXJ = serverUrl.concat(":8084/"); //正式环境
//        BASE_URL_PSXJ = serverUrl.concat("/");
//        BASE_URL_PSXJ = serverUrl.concat(":8490/");
    ...
    public static String getGcjsUrl() {
//        return "http://tsdev.geekhh.com:7050/";
        return BASE_URL_PSXJ;
    }
    ...
    /**
     * 仅用于测试目前没有的接口，之后会删除， {@link #serverUrl()}
     */
