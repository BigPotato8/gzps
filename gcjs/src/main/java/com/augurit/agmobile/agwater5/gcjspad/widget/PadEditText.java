 ...
 * @modifyMemo 修改备注：
 */
public class PadEditText extends AGEditText {

    public PadEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected void initView(Context context, AttributeSet attrs) {
        ...
        View view = SkinManager.getInstance().inflate(context, R.layout.view_edit_text_pad, this);
