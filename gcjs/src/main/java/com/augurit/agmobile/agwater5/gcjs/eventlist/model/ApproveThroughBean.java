...
public class ApproveThroughBean {
    /**
     * approveReceiptId : null
     * receiptInstrumentId : null
     * receiptInstrumentName : 批准决定书
     * instrumentNo : PZJD20210719000300
     * applyUnitName : 梁少媚
     ...
     * modifier : null
     * modifyTime : null
     * applyinstCode : 202107190003
     * applyinstId : b26cb2a6-0b98-4af5-b3f5-a86247c94b60
     * iteminstId : db3bcc3e-200a-4613-a765-5700a6adec4b
     */

    private String approveReceiptId;
    ...
    private String applyTime4String;

    public String getApplyTime4String() {
        return applyTime4String;
    }

    public void setApplyTime4String(String applyTime4String) {
        this.applyTime4String = applyTime4String;
    }

    public String getApproveReceiptId() {
        return approveReceiptId;
    }

    public void setApproveReceiptId(String approveReceiptId) {
        this.approveReceiptId = approveReceiptId;
    }
